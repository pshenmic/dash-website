...
export function ContributingHero (): React.ReactNode {
  const t = useTranslations('contributingPage.hero')

  return (
    <section data-testid='contributing-hero' className='relative flex min-h-svh items-center justify-center overflow-hidden rounded-b-3xl bg-primary-blue dark:bg-primary-dark'>
      <Image
        src='/images/developers/contributing/hero-bg.png'
        alt='Contributing hero background'
        width={1920}
        height={1920}
