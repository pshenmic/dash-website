...
export function RoadmapBugBounty (): React.ReactNode {
  const t = useTranslations('roadmapPage.bugBounty')

  return (
    <div data-testid='roadmap-bug-bounty' className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
