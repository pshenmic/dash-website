    ...
    <section className='relative flex min-h-screen min-h-[100svh] items-center justify-center overflow-hidden rounded-b-[50px] bg-primary-blue dark:bg-primary-dark'>
      ...
      <div className='relative z-10 flex flex-col items-center gap-[35px] px-6 py-12 lg:max-w-7xl lg:px-16'>
        <div className='flex max-w-full flex-col items-center gap-[15px]'>
          ...
          <h1 className='max-w-full whitespace-pre-line text-center text-[32px] font-extrabold leading-[1.1] tracking-[-0.03em] text-primary-white sm:text-[38px] sm:leading-[1.05] lg:whitespace-pre lg:text-[64px] xl:text-[80px] 2xl:text-[96px] animate-[fade-in-up_0.6s_ease-out_0.4s_both]'>
            {t('title')}
          </h1>
          <p className='max-w-full text-center text-base font-medium leading-[1.37] text-primary-white sm:text-lg lg:max-w-[724px] lg:text-[28px] lg:tracking-[-0.03em] animate-[fade-in-up_0.6s_ease-out_0.6s_both]'>
            {t('subtitle')}
          </p>
        </div>

        <div className='flex flex-col items-center gap-2.5 lg:flex-row lg:gap-[15px] animate-[fade-in-up_0.6s_ease-out_0.8s_both]'>
