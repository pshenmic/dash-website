...
export function FinancialServicesHero (): React.ReactNode {
  ...
  return (
    <section className='relative flex min-h-svh items-center justify-center overflow-hidden rounded-b-3xl bg-primary-blue dark:bg-primary-dark'>
      ...
      <div className='relative z-10 flex flex-col items-center gap-9 px-6 py-12 lg:px-16'>
        <div className='flex max-w-full flex-col items-center gap-4'>
          ...
          <Heading as='h1' className='max-w-full animate-fade-in-up-2 text-center text-4xl leading-tight font-extrabold tracking-tight whitespace-pre-line text-primary-white sm:text-4xl sm:leading-tight lg:text-6xl lg:leading-[1.02] lg:whitespace-pre xl:text-7xl 2xl:text-8xl'>
            {t('title')}
          </Heading>
        ...
        <div className='animate-fade-in-up-4'>
          <button className='flex h-16 items-center gap-4 rounded-full bg-white/15 py-2.5 pr-2.5 pl-9 text-lg font-semibold text-white backdrop-blur-sm transition-opacity hover:opacity-90'>
            {t('button')}
