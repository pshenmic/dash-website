        ...
        <div className='flex flex-col items-center gap-12 lg:flex-row lg:items-start lg:justify-between'>
          <div className='flex max-w-[469px] flex-col gap-[35px]'>
            <div className='flex flex-col gap-[15px]'>
              ...
              <h2 className='text-[32px] leading-[40px] font-extrabold tracking-[-0.03em] text-primary-dark lg:text-[38px] dark:text-primary-white'>
                {t('title')}
              </h2>
            ...
            <div className='flex gap-[15px]'>
              <div className='flex h-[111px] flex-1 flex-col justify-center rounded-[36px] border border-primary-blue px-[29px] lg:h-[143px] dark:border-0 dark:bg-primary-blue/15'>
                ...
                <span className='text-[38px] leading-[40px] font-extrabold tracking-[-0.03em] text-primary-blue'>
