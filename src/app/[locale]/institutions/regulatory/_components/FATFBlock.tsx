  ...
  return (
    <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
      <div className='relative overflow-hidden rounded-3xl bg-primary-blue lg:rounded-4xl'>
        <div className='relative z-10 flex flex-col items-center gap-10 p-8 lg:flex-row lg:items-center lg:p-16'>
          {/* Left — FATF shield */}
          <Image
            ...
            width={192}
            height={352}
            className='h-auto w-32 shrink-0 object-contain lg:w-48'
          />
          ...
          <div className='flex max-w-xl flex-col gap-6'>
            ...
            <div>
              <button className='flex items-center gap-4 rounded-2xl bg-white/15 px-4 py-2.5 text-base font-semibold text-white backdrop-blur-sm transition-opacity hover:opacity-90'>
                {t('button')}
