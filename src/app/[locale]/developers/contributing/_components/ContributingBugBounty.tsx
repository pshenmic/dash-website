...
export function ContributingBugBounty (): React.ReactNode {
  const t = useTranslations('contributingPage.bugBounty')

  return (
    <div data-testid='contributing-bug-bounty' className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
      <div className='relative flex h-72 flex-col justify-center overflow-hidden rounded-3xl bg-primary-blue px-5 py-6 dark:border dark:border-white/15 dark:bg-secondary-space-cadet lg:h-88 lg:rounded-4xl lg:px-0 lg:py-0'>
        ...
        <div className='relative z-10 flex max-w-72 flex-col gap-6 lg:ml-24 lg:max-w-100 lg:gap-9'>
          ...
          <button className='flex h-16 w-fit items-center justify-center rounded-2xl bg-white/90 px-9 text-lg font-semibold text-primary-blue backdrop-blur-sm transition-opacity hover:opacity-90'>
            {t('button')}
          </button>
        </div>
      </div>
